...
from data_aug.contrastive_learning_dataset import ContrastiveLearningDataset, PANDA_Dataset
...
main_dir = '/content/drive/Shareddrives/Digital Pathology/PANDA'
tiles_dir = '/content/patches'
model_dir = os.path.join(main_dir, 'Model')
train_csv = os.path.join(main_dir, 'df_train')
test_csv = os.path.join(main_dir, 'df_test')
val_csv = os.path.join(main_dir, 'df_val')
tiles_csv = os.path.join(main_dir, 'tiles.csv')
tiles_zip = os.path.join(main_dir, 'tiles.zip')
...
def main():
    ...
    train_dataset = PANDA_Dataset(tiles_dir, df_train)
